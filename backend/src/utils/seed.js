...
const USERS_SEED = [
  ...
  { name: 'IS Manager', email: 'ishead@iinvsys.com', password: PW.head, role: 'inside_sales_manager',
    reportsTo: 'director@iinvsys.com', designation: 'Inside Sales Manager', target: 0 },
  { name: 'Priya Krishnan', email: 'priya.k@iinvsys.com', password: PW.exec, role: 'inside_sales_executive',
    reportsTo: 'ishead@iinvsys.com', designation: 'Sr. IS Executive', color: 'var(--emerald)' },
  { name: 'Rajan V', email: 'rajan.v@iinvsys.com', password: PW.exec, role: 'inside_sales_executive',
    reportsTo: 'ishead@iinvsys.com', designation: 'IS Executive', color: 'var(--amber)' },
  { name: 'Suha M', email: 'suha.m@iinvsys.com', password: PW.exec, role: 'inside_sales_executive',
    reportsTo: 'ishead@iinvsys.com', designation: 'IS Executive', color: 'var(--azure)' },
  { name: 'Arun K', email: 'arun.k@iinvsys.com', password: PW.exec, role: 'inside_sales_executive',
    reportsTo: 'ishead@iinvsys.com', designation: 'IS Executive (New)', color: 'var(--violet)' },

  /* ── Module 2: Sales (doc 2), under the SPENCO CRM brief's zone tier ──
     Two Zonal Sales Managers, each with two Area Sales Managers (doc 2's four domain
     managers), each with two Sales Executives. `zone` is inherited down the chart. */
  { name: 'Meera Iyer', email: 'meera.i@iinvsys.com', password: PW.head, role: 'zonal_sales_manager',
    reportsTo: 'director@iinvsys.com', zone: 'north', designation: 'Zonal Sales Manager — North', target: 12500000 },
  { name: 'Rohan Desai', email: 'rohan.d@iinvsys.com', password: PW.head, role: 'zonal_sales_manager',
    reportsTo: 'director@iinvsys.com', zone: 'south', designation: 'Zonal Sales Manager — South', target: 10000000 },

  { name: 'Vikram Nair', email: 'vikram.n@iinvsys.com', password: PW.head, role: 'area_sales_manager',
    reportsTo: 'meera.i@iinvsys.com', zone: 'north', domain: 'railways', designation: 'Area Sales Manager 1', target: 7500000 },
  { name: 'Deepa Rajan', email: 'deepa.r@iinvsys.com', password: PW.head, role: 'area_sales_manager',
    reportsTo: 'meera.i@iinvsys.com', zone: 'north', domain: 'defence', designation: 'Area Sales Manager 2', target: 5000000 },
  { name: 'Anita Menon', email: 'anita.m@iinvsys.com', password: PW.head, role: 'area_sales_manager',
    reportsTo: 'rohan.d@iinvsys.com', zone: 'south', domain: 'space_satellite', designation: 'Area Sales Manager 3', target: 6000000 },
  { name: 'Karthik P', email: 'karthik.p@iinvsys.com', password: PW.head, role: 'area_sales_manager',
    reportsTo: 'rohan.d@iinvsys.com', zone: 'south', domain: 'automotive', designation: 'Area Sales Manager 4', target: 4000000 },

  { name: 'Exec A', email: 'exec.a@iinvsys.com', password: PW.exec, role: 'sales_executive',
    reportsTo: 'vikram.n@iinvsys.com', zone: 'north', domain: 'railways', territory: 'Delhi NCR', target: 5000000 },
  { name: 'Exec B', email: 'exec.b@iinvsys.com', password: PW.exec, role: 'sales_executive',
    reportsTo: 'vikram.n@iinvsys.com', zone: 'north', domain: 'railways', territory: 'Chennai', target: 3000000 },
  { name: 'Exec C', email: 'exec.c@iinvsys.com', password: PW.exec, role: 'sales_executive',
    reportsTo: 'deepa.r@iinvsys.com', zone: 'north', domain: 'defence', territory: 'Bangalore', target: 4000000 },
  { name: 'Exec D', email: 'exec.d@iinvsys.com', password: PW.exec, role: 'sales_executive',
    reportsTo: 'deepa.r@iinvsys.com', zone: 'north', domain: 'defence', territory: 'Hyderabad', target: 3000000 },
  { name: 'Exec E', email: 'exec.e@iinvsys.com', password: PW.exec, role: 'sales_executive',
    reportsTo: 'anita.m@iinvsys.com', zone: 'south', domain: 'space_satellite', territory: 'Bangalore', target: 3500000 },
  { name: 'Exec F', email: 'exec.f@iinvsys.com', password: PW.exec, role: 'sales_executive',
    reportsTo: 'anita.m@iinvsys.com', zone: 'south', domain: 'space_satellite', territory: 'Trivandrum', target: 3000000 },
  { name: 'Exec G', email: 'exec.g@iinvsys.com', password: PW.exec, role: 'sales_executive',
    reportsTo: 'karthik.p@iinvsys.com', zone: 'south', domain: 'automotive', territory: 'Pune', target: 3000000 },
  { name: 'Exec H', email: 'exec.h@iinvsys.com', password: PW.exec, role: 'sales_executive',
    reportsTo: 'karthik.p@iinvsys.com', zone: 'south', domain: 'automotive', territory: 'Chennai', target: 2500000 },
