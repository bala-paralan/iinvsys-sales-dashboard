...
const ROUTES = [
  { method: 'get', path: '/api/users',
    allow: ['superadmin', 'sales_director', 'inside_sales_manager', 'zonal_sales_manager', 'area_sales_manager', 'production_head', 'install_head', 'cs_manager'] },
  ...
  { method: 'get', path: '/api/leads',
    allow: ['superadmin', 'sales_director', 'inside_sales_manager', 'inside_sales_executive', 'zonal_sales_manager', 'area_sales_manager', 'sales_executive', 'referrer'] },
  { method: 'get', path: '/api/leads/hygiene',
    allow: ['superadmin', 'sales_director', 'inside_sales_manager', 'inside_sales_executive', 'zonal_sales_manager', 'area_sales_manager', 'sales_executive'] },
  ...
  { method: 'get', path: '/api/coaching-notes',
    allow: ['superadmin', 'sales_director', 'inside_sales_manager', 'zonal_sales_manager', 'area_sales_manager', 'cs_manager'] },
  { method: 'get', path: '/api/approvals',
    allow: ALL_ROLES.filter((r) => r !== 'referrer') },
  { method: 'get', path: '/api/workorders',
    allow: ['superadmin', 'sales_director', 'zonal_sales_manager', 'area_sales_manager', 'sales_executive',
